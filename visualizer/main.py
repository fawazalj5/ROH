...
def visualize_field(phenomenal_field, agent_id):
    """
    Generates a 3D scatter plot of the Autonic Phenomenal Field for a given agent.
    """
    agent_states = []
    ...
    fig.update_layout(
        title=f"Autonic Phenomenal Field for Agent {agent_id}",
        scene=dict(
